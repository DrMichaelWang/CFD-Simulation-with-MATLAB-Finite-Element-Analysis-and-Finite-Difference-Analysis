...
rou=1.977; %rou is the density of water,which unit is kg/m3
mu=0.0000137;%mu is the dynamic viscosity of water,which unit is Pa*s (kg/(m*s))
Vy0=100;%Vy0 is the initial velocity, which unit is m/s
