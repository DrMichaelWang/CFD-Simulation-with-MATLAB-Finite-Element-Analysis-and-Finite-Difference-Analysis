...
L1=0.8393*10^(-3); %Dimension along the X direction,its unit is m
...
b=-0.176327; %b is the constant term in the L(y) function
Zmean=-2.68817*10^(-7);
xmax=400;
dx=L1/xmax;
dy=dx;
...
for j=1:ymax+2
    v(xstartpoint,j)=0;
    if j/6==round(j/6), xstartpoint=xstartpoint-1;end
end
