function v=WATER
rou=1000; %rou is the density of CO2,which unit is kg/m3
mu=10*10^(-3);%mu is the dynamic viscosity of soybean oil,which unit is Pa*s (kg/(m*s))
...
B1=0.31*10^(-3); %Dimension along the Z direction,unit=m
